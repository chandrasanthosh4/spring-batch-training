...
public class ExportDbToFileBatchJobApp {

	public static void main(String[] args) {
		
		ApplicationContext context = SpringApplication.run(ExportDbToFileBatchJobApp.class, args);
		...
		Job job = (Job) (context.getBean("ExportDbToFileJob"));
