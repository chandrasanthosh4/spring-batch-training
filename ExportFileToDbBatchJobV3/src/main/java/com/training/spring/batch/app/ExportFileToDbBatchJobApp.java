...
public class ExportFileToDbBatchJobApp {
	...
	public static void main(String[] args) {
		...
		try {
			...
			JobParameter fileArchivalLocationJobParam = new JobParameter("C://Users//sapenumarthi//batchjobs_archive//");
			...
			parameters.put("JOB_PARAM_FILE_ARCHIVAL_LOC", fileArchivalLocationJobParam);
